...
<title>事务变动</title>
<meta name="keywords" content="安全实时监控"/>
<meta name="description" content="为您的美好生活实时助力"/>
    ...
    <div class="left-bar">
        ...
        <div class="menu" id="menu">
            <ul class="scrollcontent">
                ...
                <li><a href="./index1.html">事务变动</a></li>
                <li><a href="./index2.html">人员变动</a></li>
            </ul>
        </div>
    </div>
    <!--内容-->
    <div class="main">
        <div class="container content-box">
            ...
            <div class="container content-table">
                <table>
                    <tr>
                        <th scope="col" class="table-text">事务编号</th>
                        <th scope="col" class="table-text">事务反馈人</th>
                        <th scope="col" class="table-text">事务类型</th>
                        <th scope="col" class="table-text">事务发生事件</th>
                        <th scope="col" class="table-text">事务详细描述</th>
                        <th scope="col" class="table-text">事务状态</th>
                    </tr>
                    <tr>
            ...
            <div class="container">
                <div class="rwo">
                    <div class="col-md-12">
                        <p>
                            本站内容一切均符合网络要求，如有发现任何网络漏洞，请联系我们对相关内容进行调整，联系邮箱：5451@163.com
                        </p>
                    </div>
                </div>
            </div>
